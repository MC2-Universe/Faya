...
export default {
  ...
  branchingDisable: 'The Subtopic feature is only available in the server version. If you need this feature, please switch to server deployment mode or use Faya Cloud.',
  cancel: 'Cancel',
  changelog: 'Changelog',
  clientDB: {
    autoInit: {
  ...
  footer: {
    ...
    feedback: {
      ...
      desc: 'Every idea and suggestion from you is precious to us. We cannot wait to hear your thoughts! Feel free to contact us to provide feedback on product features and user experience, helping us make Faya even better.',
...
    'zh-TW': 'Traditional Chinese'
  ...
  telemetry: {
    allow: 'Allow',
    deny: 'Deny',
    desc: 'We would like to anonymously collect usage information to help us improve Faya and provide you with a better product experience. You can disable this at any time in Settings - About.',
    learnMore: 'Learn More',
    title: 'Help Faya be better'
  },
  temp: 'Temporary',
