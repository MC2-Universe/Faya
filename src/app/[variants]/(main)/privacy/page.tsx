      ...
      <Flexbox gap={isMobile ? 16 : 48}>
        ...
        >
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Faya, the software program provided by the
                Company.
              </p>
            </li>
            <li>
          ...
          <p>
            Usage Data may include information such as Your Device Internet Protocol address (e.g.
          ...
          <p>
            ...
            Third-Party Social Media account, such as Your name, Your email address, Your activities
            or Your contact list associated with that account.
          </p>
          <p>
            You may also have the option of sharing additional information with the Company through
            Your Third-Party Social Media account. If You choose to provide such information and
            Personal Data, during registration or otherwise, You are giving the Company permission
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                other equivalent forms of electronic communication, such as a mobile applications
          ...
          <p>
            Your information, including Personal Data, is processed at the Company operating offices
          ...
          <p>
            ...
            country requires consent from a parent, We may require Your parents consent before We
            collect and use that information.
          </p>
          <h2>Links to Other Websites</h2>
          <p>
            Our Service may contain links to other websites that are not operated by Us. If You
            click on a third party link, You will be directed to that third party site. We strongly
          ...
          <ul>
            <li>By email: hello@faya.chat</li>
          </ul>
        </Suspense>
      </Flexbox>
      <GridLayout>
