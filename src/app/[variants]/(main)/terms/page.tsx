      ...
      <Flexbox gap={isMobile ? 16 : 48}>
        ...
        >
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Faya.Chat
              </p>
            </li>
            <li>
              <p>
          ...
          <p>
            ...
            Service or 100 USD if You haven not purchased anything through the Service.
          </p>
          <p>
          ...
          <p>
            ...
            may not apply. In these states, each party liability will be limited to the greatest
