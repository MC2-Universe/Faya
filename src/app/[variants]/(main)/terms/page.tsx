...
export const generateMetadata = async (props: DynamicLayoutProps) => {
  ...
  return metadataModule.generate({
    canonical: urlJoin(OFFICIAL_SITE, 'terms'),
    description: t('Terms of Service', { appName: BRANDING_NAME }),
...
const Page = async (props: DynamicLayoutProps) => {
  ...
  const ld = ldModule.generate({
    description: t('Terms of Service', { appName: BRANDING_NAME }),
    title: t('Terms of Service', { appName: BRANDING_NAME }),
    url: '/terms',
  });
          ...
          <div data-custom-class="body">
            <div>
              ...
              <div data-custom-class="subtitle">
                <strong>Last updated</strong> <strong>April 21, 2025</strong>
              </div>
              <div>
            ...
            <div>
              <div data-custom-class="body_text">
                We are MC2 (MCrowdsourcing Canada Inc.), doing business as Faya ("
                <strong>Company</strong>," "<strong>we</strong>," "<strong>us</strong>," "
                <strong>our</strong>"), a company registered in Ottawa, Canada and located at 150
                Elgin Street Floor 10 Ottawa ON K2P 1L4 Canada.
              </div>
            </div>
            <div>
              <div data-custom-class="body_text">
                We operate the website https://faya.chat (the "<strong>Site</strong>"), the mobile
                application Faya (the "<strong>App</strong>"), as well as any other related products
              ...
              <div data-custom-class="body_text">
                You can contact us by email at hello@faya.chat or by mail to 150 Elgin Street Floor
                10 Ottawa ON K2P 1L4 Canada.
              </div>
              <div data-custom-class="body_text">
                These Legal Terms constitute a legally binding agreement made between you, whether
                personally or on behalf of an entity ("<strong>you</strong>"), and Faya, concerning
                ...
                YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED
              ...
              <div data-custom-class="body_text">
                ...
                Legal Terms to stay informed of updates. You will be subject to, and will be deemed
                to have been made aware of and to have accepted, the changes in any revised Legal
                Terms by your continued use of the Services after the date such revised Legal Terms
                are posted.
              </div>
            </div>
            <div>
              ...
              <div>
                <a href="#mobile">8. MOBILE APPLICATION LICENSE</a>
              </div>
              <div>
              ...
              <div>
                <a href="#copyrightyes">12. COPYRIGHT INFRINGEMENTS</a>
              </div>
              <div>
            ...
            <div>
              ...
              <div data-custom-class="body_text">
                ...
                hello@faya.chat. If we ever grant you the permission to post, reproduce, or publicly
            ...
            <div>
              ...
              <div data-custom-class="body_text">
                <strong>Contributions:</strong> The Services may invite you to chat, contribute to,
              ...
              <div data-custom-class="body_text">
                ...
                and license to: use, copy, reproduce, distribute, sell, resell, publish, broadcast,
                ...
                and to sublicense the licenses granted in this section. Our use and distribution may
              ...
              <ul>
                <li data-custom-class="body_text">
                  ...
                  upload, or transmit through the Services any Submission nor post any Contribution
              ...
              <div data-custom-class="body_text">
                ...
                your breach of (a) this section, (b) any third party&rsquo;s intellectual property
                rights, or (c) applicable law.
              </div>
              <div data-custom-class="body_text">
                <strong>We may remove or edit your Content:</strong> Although we have no obligation
                ...
                such Contributions harmful or in breach of these Legal Terms. If we remove or edit
                any such Contributions, we may also suspend or disable your account and report you
                to the authorities.
              </div>
              <div data-custom-class="heading_2">
              ...
              <div data-custom-class="body_text">
                ...
                or control, please immediately refer to the "
            ...
            <div>
              <div data-custom-class="body_text">
                ...
                comply with these Legal Terms; (4) you are not under the age of 13;&nbsp;(5) you are
                ...
                otherwise; (7) you will not use the Services for any illegal or unauthorized
            ...
            <div>
                    ...
                    <div>
                      ...
                      <ul>
                        ...
                        <li data-custom-class="body_text">
                          ...
                          formats ("gifs"), 1&times;1 pixels, web bugs, cookies, or other similar
                        ...
                        <li data-custom-class="body_text">
                          Use the service to break any law in any country
                        </li>
                        <li data-custom-class="body_text">
                          Use the service to harm yourself or any other
                        </li>
                      </ul>
                      <div data-custom-class="heading_1">
              ...
              <div>
                <div data-custom-class="heading_1">
                  <h2 id="mobile">8. MOBILE APPLICATION LICENSE</h2>
                </div>
                <div data-custom-class="heading_2">
                  <h3>Use License</h3>
                </div>
                <div data-custom-class="body_text">
                  ...
                  App on such devices strictly in accordance with the terms and conditions of this
                  ...
                  work from the App; (3) violate any applicable laws, rules, or regulations in
                  ...
                  or the licensors of the App; (5) use the App for any revenue-generating endeavor,
                  commercial enterprise, or other purpose for which it is not designed or intended;
                  (6) make the App available over a network or other environment permitting access
                  or use by multiple devices or users at the same time; (7) use the App for creating
                  a product, service, or software that is, directly or indirectly, competitive with
                  or in any way a substitute for the App; (8) use the App to send automated queries
                  to any website or to send any unsolicited commercial email; or (9) use any
                ...
                <div data-custom-class="body_text">
                  ...
                  license granted to you for our App is limited to a non-transferable license to use
                  ...
                  applicable App Distributor&rsquo;s terms of service; (2) we are responsible for
                  providing any maintenance and support services with respect to the App as
                  specified in the terms and conditions of this mobile application license contained
                  in these Legal Terms or as otherwise required under applicable law, and you
                  ...
                  failure of the App to conform to any applicable warranty, you may notify the
                  applicable App Distributor, and the App Distributor, in accordance with its terms
                  and policies, may refund the purchase price, if any, paid for the App, and to the
                  ...
                  "terrorist supporting" country and (ii) you are not listed on any US government
                  ...
                  mobile application license contained in these Legal Terms, and that each App
                ...
                <div data-custom-class="heading_1">
                  <h2 id="socialmedia">9. SOCIAL MEDIA</h2>
                </div>
                <div>
                  <div data-custom-class="body_text">
                ...
                <div data-custom-class="body_text">
                  ...
                  <strong>&nbsp;faya.chat/privacy</strong>. By using the Services, you agree to be
                  bound by our Privacy Policy, which is incorporated into these Legal Terms. Please
                  ...
                  laws in Canada or the United States, then through your continued use of the
                  ...
                  Children&rsquo;s Online Privacy Protection Act, if we receive actual knowledge
                ...
                <div data-custom-class="heading_1">
                  <h2 id="copyrightyes">12. COPYRIGHT INFRINGEMENTS</h2>
                </div>
                <div data-custom-class="body_text">
                  We respect the intellectual property rights of others. If you believe that any
                  material available on or through the Services infringes upon any copyright you own
                ...
                <div data-custom-class="body_text">
                  ...
                  accordance with the laws of the Province of Ontario applicable to agreements made
                  and to be entirely performed within&nbsp;the Province of Ontario,&nbsp;without
                ...
                <div data-custom-class="body_text">
                  ...
                  those Disputes expressly provided below) informally for at least sixty (60) days
                ...
                <div data-custom-class="body_text">
                  ...
                  AAA&rsquo;s Supplementary Procedures for Consumer Related Disputes ("AAA Consumer
                  ...
                  of documents, by phone, or online. The arbitrator will make a decision in writing,
                  ...
                  rules or applicable law, the arbitration will take place in Ottawa, Ontario.
                ...
                <div data-custom-class="body_text">
                  ...
                  courts&nbsp;located in Ottawa,&nbsp;Ontario, and the Parties hereby consent to,
                ...
                <div data-custom-class="body_text">
                  ...
                  RESULTING FROM YOUR ACCESS TO AND USE OF THE SERVICES, (3) ANY UNAUTHORIZED ACCESS
                ...
                <div>
                  ...
                  OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE three (3) MONTH PERIOD PRIOR
                  TO ANY CAUSE OF ACTION ARISING OR $100.00 USD.&nbsp;CERTAIN US STATE LAWS AND
                  INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION
                ...
                <div data-custom-class="heading_1">
                  <h2 id="idemnification">20. INDEMNIFICATION</h2>
                </div>
                <div data-custom-class="body_text">
                  ...
                  arising out of: (1) your Contributions;&nbsp;(2) use of the Services; (3) breach
                  of these Legal Terms; (4) any breach of your representations and warranties set
                ...
                <div data-custom-class="body_text">
                  ...
                  have undertaken using the Services. You agree that we shall have no liability to
                  you for any loss or corruption of any such data, and you hereby waive any right of
                ...
                <div data-custom-class="heading_1">
                  <h2 id="california">23. CALIFORNIA USERS AND RESIDENTS</h2>
                </div>
                <div data-custom-class="body_text">
                ...
                <div data-custom-class="body_text">
                  ...
                  does not affect the validity and enforceability of any remaining provisions. There
                ...
                <div data-custom-class="body_text">
                  <strong>150 Elgin Street Floor 10</strong>
                </div>
                <div data-custom-class="body_text">
                  <strong>Ottawa ON K2P 1L4</strong>
                </div>
                <div data-custom-class="body_text">
